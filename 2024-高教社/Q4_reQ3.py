...
# 零配件和半成品及成品数据
parts_data = {
    '零件A': {'次品率': 0.1246, '单价': 2, '检测费': 1},
    '零件B': {'次品率': 0.1246, '单价': 8, '检测费': 1},
    '零件C': {'次品率': 0.1246, '单价': 12, '检测费': 2},
    '零件D': {'次品率': 0.1246, '单价': 2, '检测费': 1},
    '零件E': {'次品率': 0.1246, '单价': 8, '检测费': 1},
    '零件F': {'次品率': 0.1246, '单价': 12, '检测费': 2},
    '零件G': {'次品率': 0.1246, '单价': 8, '检测费': 1},
    '零件H': {'次品率': 0.1246, '单价': 12, '检测费': 2},
}

sub_assemblies = {
    '组件A': {'次品率': 0.1246, '组装费': 8, '检测费': 4, '拆解费': 6},
    '组件B': {'次品率': 0.1246, '组装费': 8, '检测费': 4, '拆解费': 6},
    '组件C': {'次品率': 0.1246, '组装费': 8, '检测费': 4, '拆解费': 6},
}
...
# 保存到Excel
df_strategies.to_excel('re策略结果.xlsx', index=False)
print("策略已保存到文件 're策略结果.xlsx'。")
